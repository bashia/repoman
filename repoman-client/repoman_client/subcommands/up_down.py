...
############################################
from repoman_client.imagessl import ver,sign
############################################
import sys
import logging
...
class UploadImage(SubCommand):
    ...
    def get_parser(self):
        ...
        ###################################################################################
        p.add_argument('--sign', action='store_true', default = False,
                        help='Whether or not you are invoking the signing option')
        p.add_argument('-key', help='The location of the private key you are signing with')
        ###################################################################################
        return p
